...
Route::middleware([
    ...
    Route::prefix('events')->group(function () {
        ...
        Route::get('/data', [EventController::class, 'data'])->name('events.data');
    ...
    Route::prefix('event-templates')->group(function () {
        ...
        Route::get('/data', [EventTemplateController::class, 'data'])->name('event-templates.data');
    ...
    Route::prefix('field-templates')->group(function () {
        ...
        Route::get('/data', [FieldTemplateController::class, 'data'])->name('field-templates.data');
