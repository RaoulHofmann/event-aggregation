...
Route::middleware([
    ...
    Route::prefix('events')->group(function () {
        ...
        Route::get('/get', [EventController::class, 'store'])->name('events.get');
    ...
    Route::prefix('event-templates')->group(function () {
        ...
        Route::get('/get', [EventTemplateController::class, 'store'])->name('event-templates.get');
    ...
    Route::prefix('field-templates')->group(function () {
        ...
        Route::get('/get', [FieldTemplateController::class, 'index'])->name('field-templates.get');
